...
:: Android packaging
set AND_CERT_NAME="Feeding Frenzy New"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\FeedingFrenzyNew.p12
...
set IOS_PROVISION=cert\FeedingFrenzyNew.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=FeedingFrenzyNew
